...
const Navbar: React.FC = () => {
  ...
  const navItems = ['frontend developer', 'projects', 'code examples', 'skills', 'about', 'contact'];
              ...
              {navItems.map((section) => (
                <button
                  ...
                  className="text-gray-700! dark:text-gray-200! hover:text-blue-600! dark:hover:text-blue-400! 
                           hover:g-gray-100! dark:hover:bg-gray-700! px-4 py-2 rounded-lg text-sm font-medium 
