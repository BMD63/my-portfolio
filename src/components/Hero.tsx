...
const Hero: React.FC = () => {
  ...
  return (
    <section id="frontend developer" className="pt-16 min-h-screen flex items-center justify-center bg-linear-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
